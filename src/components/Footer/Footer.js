      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
        ...
        <div className="container mx-auto py-10 px-4">
          <div className="mb-8 md:mb-0 md:flex-1 md:text-center">
            ...
            <p>We are a leading hotel company providing the best services to our guests. Our goal is to ensure a comfortable and memorable stay for all our customers.</p>
          </div>
        </div>
        ...
        <div className="container mx-auto py-10 px-4">
          <div id="contact" className="mb-8 md:mb-0 md:flex-1 md:text-right">
            ...
            <p>123 Hotel Avenue, Cityville, Country</p>
            <p>Phone: +123 456 789</p>
            <p>Email: info@hotelgo.com</p>
          </div>
        </div>
