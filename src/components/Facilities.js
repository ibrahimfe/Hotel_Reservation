      ...
      <div className="container mx-auto py-10 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          ...
          <div className="relative rounded-xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-white text-2xl font-bold">TV</div>
          </div>
          <div className="relative rounded-xl overflow-hidden">
            <img src={kitchen} alt="Kitchen" className="w-full h-48 object-cover rounded" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-white text-2xl font-bold">Kitchen</div>
          </div>
          <div className="relative rounded-xl overflow-hidden">
            <img src={bathroom} alt="Bathroom" className="w-full h-48 object-cover rounded" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-white text-2xl font-bold">Bathroom</div>
          </div>
          <div className="relative rounded-xl overflow-hidden">
            <img src={garden} alt="Garden" className="w-full h-48 object-cover rounded" />
            <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center text-white text-2xl font-bold">Garden</div>
          </div>
        </div>
      </div>
    </div>
